...
saveExtraState:function(){return null},loadExtraState:function(){}};$.defineBlocks$$module$build$src$core$common(blocks$$module$build$src$blocks$lists);var module$build$src$blocks$lists={blocks:blocks$$module$build$src$blocks$lists};var blocks$$module$build$src$blocks$customs=$.createBlockDefinitionsFromJsonArray$$module$build$src$core$common([{type:"custom_get_temparature",message0:"HELLO",previousStatement:null,nextStatement:null,colour:330,tooltip:"\u83b7\u53d6\u6e29\u5ea6\u503c",helpUrl:"www.iciwh.com"},{type:"char",message0:"char name%1 =%2",args0:[{type:"field_input",name:"NAME",check:"String"},{type:"field_input",name:"context",check:"String"}],previousStatement:null,nextStatement:null,colour:230,tooltip:"\u5b9a\u4e49\u5b57\u7b26\u4e32\u5e76\u521d\u59cb\u5316",
helpUrl:""},{type:"string_",message0:"char* name%1 ",args0:[{type:"field_input",name:"NAME",check:"String"}],previousStatement:null,nextStatement:null,colour:230,tooltip:"\u5b9a\u4e49\u5b57\u7b26\u4e32",helpUrl:""},{type:"customcharname",message0:"string %1",args0:[{type:"field_dropdown",name:"NAME",options:function(){return $.globalNames$$module$build$src$generators$c$c_generator.map(a=>[a,a])}}],output:null,colour:230,tooltip:"\u5b57\u7b26\u4e32\u7c7b\u578b\u7684\u53d8\u91cf",helpUrl:""},{type:"customintname",
message0:"int %1",args0:[{type:"field_dropdown",name:"NAME",options:function(){return $.globalintNames$$module$build$src$generators$c$c_generator.map(a=>[a,a])}}],output:null,colour:230,tooltip:"int\u7c7b\u578b\u7684\u53d8\u91cf",helpUrl:""},{type:"customstructname",message0:"struct %1",args0:[{type:"field_dropdown",name:"NAME",options:function(){return $.globalStructVarNames$$module$build$src$generators$c$c_generator.map(a=>[a,a])}}],output:null,colour:230,tooltip:"\u7ed3\u6784\u4f53\u7c7b\u578b\u7684\u53d8\u91cf",
helpUrl:""},{type:"uint32_t",message0:"uint32_t %1",args0:[{type:"field_input",name:"NAME",check:"String"}],inputsInline:!0,previousStatement:null,nextStatement:null,colour:230,tooltip:"",helpUrl:""},{type:"int_set",message0:"set int %1 %2",args0:[{type:"field_dropdown",name:"NAME",options:function(){return $.globalintNames$$module$build$src$generators$c$c_generator.map(a=>[a,a])}},{type:"input_value",name:"VALUE"}],previousStatement:null,nextStatement:null,colour:230,tooltip:"",helpUrl:""},{type:"string_set",
message0:"set string %1 %2",args0:[{type:"field_dropdown",name:"NAME",options:function(){return $.globalNames$$module$build$src$generators$c$c_generator.map(a=>[a,a])}},{type:"input_value",name:"VALUE"}],previousStatement:null,nextStatement:null,tooltip:"",helpUrl:""},{type:"structure",message0:"%1 %2",args0:[{type:"field_input",name:"NAME",text:"Struct"},{type:"input_statement",name:"FIELDS"}],colour:230,previousStatement:null,nextStatement:null,tooltip:"",helpUrl:""},{type:"alarm_struct",message0:"Struct %1 %2",
args0:[{type:"field_dropdown",name:"NAME",options:function(){return $.globalStructNames$$module$build$src$generators$c$c_generator.map(a=>[a,a])}},{type:"field_input",name:"NAME"}],output:null,previousStatement:null,nextStatement:null,colour:230,tooltip:"\u58f0\u660e\u4e00\u4e2a\u7ed3\u6784\u4f53\u7c7b\u578b",helpUrl:""}]);$.defineBlocks$$module$build$src$core$common(blocks$$module$build$src$blocks$customs);var module$build$src$blocks$customs={blocks:blocks$$module$build$src$blocks$customs};var blocks$$module$build$src$blocks$colour=$.createBlockDefinitionsFromJsonArray$$module$build$src$core$common([{type:"colour_picker",message0:"%1",args0:[{type:"field_colour",name:"COLOUR",colour:"#ff0000"}],output:"Colour",helpUrl:"%{BKY_COLOUR_PICKER_HELPURL}",style:"colour_blocks",tooltip:"%{BKY_COLOUR_PICKER_TOOLTIP}",extensions:["parent_tooltip_when_inline"]},{type:"colour_random",message0:"%{BKY_COLOUR_RANDOM_TITLE}",output:"Colour",helpUrl:"%{BKY_COLOUR_RANDOM_HELPURL}",style:"colour_blocks",
...
args0:[{type:"input_value",name:"COLOUR1",check:"Colour",align:"RIGHT"},{type:"input_value",name:"COLOUR2",check:"Colour",align:"RIGHT"},{type:"input_value",name:"RATIO",check:"Number",align:"RIGHT"}],output:"Colour",helpUrl:"%{BKY_COLOUR_BLEND_HELPURL}",style:"colour_blocks",tooltip:"%{BKY_COLOUR_BLEND_TOOLTIP}"}]);$.defineBlocks$$module$build$src$core$common(blocks$$module$build$src$blocks$colour);var module$build$src$blocks$colour={blocks:blocks$$module$build$src$blocks$colour};var blocks$$module$build$src$blocks$blocks=Object.assign({},blocks$$module$build$src$blocks$colour,blocks$$module$build$src$blocks$lists,blocks$$module$build$src$blocks$logic,blocks$$module$build$src$blocks$loops,blocks$$module$build$src$blocks$math,blocks$$module$build$src$blocks$procedures,blocks$$module$build$src$blocks$variables,blocks$$module$build$src$blocks$variables_dynamic,blocks$$module$build$src$blocks$customs),module$build$src$blocks$blocks={blocks:blocks$$module$build$src$blocks$blocks,
colour:module$build$src$blocks$colour,customs:module$build$src$blocks$customs,lists:module$build$src$blocks$lists,loops:module$build$src$blocks$loops,math:module$build$src$blocks$math,procedures:module$build$src$blocks$procedures,texts:module$build$src$blocks$text,variables:module$build$src$blocks$variables,variablesDynamic:module$build$src$blocks$variables_dynamic};
