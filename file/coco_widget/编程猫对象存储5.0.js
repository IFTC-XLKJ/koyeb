    ...
    params: [
        ...
        },
        {
            ...
            dropdown: [
                ...
                { label: '文件内容(Blob)', value: 'blob' },
                { label: '文件内容(Uint8Array)', value: 'uint8_array' },
            ],
        }
    ],
    ...
    params: [
        {
            ...
            dropdown: [
                ...
                { label: ".svg(图片)", value: "image/svg+xml" },
                { label: ".bmp(图片)", value: "image/bmp" },
                { label: ".gif(图片)", value: "image/gif" },
                { label: ".webp(图片)", value: "image/webp" },
                { label: ".tif(图片)", value: "image/tiff" },
                { label: ".ico(图片)", value: "image/x-icon" },
                { label: ".heif(图片)", value: "image/heif" },
                { label: ".mp4(视频)", value: "video/mp4" },
                { label: ".avi(视频)", value: "video/avi" },
                { label: "mov(视频)", value: "video/mov" },
                { label: ".mkv(视频)", value: "video/mkv" },
                { label: ".wmv(视频)", value: "video/wmv" },
                { label: ".flv(视频)", value: "video/flv" },
                { label: ".webm(视频)", value: "video/webm" },
                { label: ".avc(视频)", value: "video/avc" },
                ...
                { label: ".m4a(音频)", value: "audio/m4a" },
                { label: ".wma(音频)", value: "audio/wma" },
                { label: ".aif(音频)", value: "audio/aif" },
                { label: ".dsd(音频)", value: "audio/dsd" },
                { label: ".txt(文本)", value: "text/plain" },
                { label: ".html(HTML)", value: "text/html" },
                { label: ".css(CSS)", value: "text/css" },
                { label: ".js(JS)", value: "text/javascript" },
