...
const VVZHkey = "LkduYVIN+ZWY+y+kN565pfAF4JJRhfpNk08tX2/Rm0dbeqAqR82HeOjnd+soDEpbSbW06EwVYT38wb0nNOx5lxTmPkmVBOErbF5mNqsyQOjMsGiImi0mbmolRNbRck3er4BHin3lsS3b1WYXDgY826RZEvDia4yFo15DuJZVFC0=";
...
class User {
  ...
  async register(email, password, nickname, avatar) {
    ...
    if (all.fields.filter((item) => item.邮箱 == email).length > 0) return {
      code: 400,
      msg: "邮箱已被注册"
    };
